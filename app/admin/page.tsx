    ...
    {topics.map((t) => (
      ...
      >
        <div className="flex gap-3">
          {t.thumbnailUrl && (
            <div className="relative flex-shrink-0 w-16 h-16 md:w-20 md:h-20 rounded-xl overflow-hidden border border-slate-200 bg-white">
              <Image
                src={t.thumbnailUrl}
                alt={t.title}
                fill
        ...
        <div className="px-5 py-4 sm:py-5 space-y-4 overflow-y-auto flex-1">
          <div className="space-y-2">
            ...
            <div className="flex gap-3 items-center">
              <div className="relative w-20 h-20 rounded-xl border border-slate-200 bg-slate-50 overflow-hidden flex items-center justify-center">
